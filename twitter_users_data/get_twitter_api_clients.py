...
class TwitterAuthClient(TwitterUserProfile):
    ...
    def get_all_auth_client(self):
        ...
        url = "https://api.twitter.com/1.1/users/lookup.json?screen_name=vidoolydotcom"
...
if __name__ == '__main__':
    ...
    data = all_auth_client[10].request("https://api.twitter.com/1.1/users/show.json?screen_name=fsrecordings")
